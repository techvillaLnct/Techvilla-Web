...
export default function Resources() {
    return (
        <div className="min-h-screen bg-cover bg-center text-white"
            ...
            <div>
                <div className="px-5">
                    <h1 className="text-center text-4xl md:text-3xl w-full font-extralight">Resources</h1>
                    <div className="space-y-12 flex flex-col items-center gap-4">
                        <h1 className="mt-8 text-center text-xl lg:text-3xl w-screen ">Enter To The Villa of Tech !</h1>
