      ...
      <div>
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1  py-4">
          <div className="flex flex-col gap-4 justify-center items-center mt-4">
            <h1 className={` text-3xl ${inter.className}`}>Total Rounds</h1>
            <p className="text-5xl ">3</p>
            <p className="text-2xl tracking-widest">Competitive Level</p>
          </div>
            ...
            <div className="flex flex-col gap-4 justify-center items-center mt-4">
              ...
              <div className="flex flex-col gap-4 justify-center items-center mt-4">
                <h1 className={` text-3xl ${inter.className}`}>Coding Platform</h1>
                <Image src={"/hackerearth.png"} alt="" width={70} height={70} />
                <p className="text-2xl tracking-widest">Hackerearth</p>
            </div>

        </div>
        <h1 id="events" className={`${inter.className} text-center text-5xl text-white  rounded-2xl p-2 mt-10 md:mt-16`}>Glimpses</h1>
        <Glimpses />
      </div>
      <div>
        <Footer />
