...
export const Button2 = ({ text, onClick }: ButtonProps) => {
  return (
    <button onClick={onClick}
      className="relative inline-flex h-12 w-28 md:h-16 md:w-48  overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ">
